...
num_episodes = 100000
Q, policy = MCES(get_episode_blackjack,initial_Q,initial_policy,gamma,alpha,num_episodes)
...
def plot_actions(actions,title_str):
    ...
    fig.savefig(title_str+'.pdf',dpi=200)
...
error_rate = float((diff_usableAce + diff_noUsableAce))/200
